...
public class FRHandler extends DefaultHandler {
    ...
    public FRHandler(String nodeName) {
    ...
    public void startElement(String uri, String localName, String qName,
        ...
        if (qName.equals("DOC")) {
            ...
            //System.out.print("探测点:"+ uri+","+localName+","+ qName+","+attributes);
    ...
    public void characters(char[] ch, int start, int length)
        ...
        if (currentTag != null ) {
            ...
            if (currentValue != null && !currentValue.equals("") && !currentValue.equals("\n")) {
                ...
                }else if(currentTag.equals("ACTION")){
                    article.setTitle(currentValue);
                }else if(currentTag.equals("SUMMARY")){
                    article.setContent(article.getContent() + " " +currentValue);
                }else if(currentTag.equals("SUPPLEM")){
                    article.setContent(article.getContent() + " " +currentValue);
                }
