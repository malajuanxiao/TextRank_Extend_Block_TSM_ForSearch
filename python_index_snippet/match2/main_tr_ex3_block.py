...
for i in range(tap_su):
    ...
    for idx,test_dict in enumerate(qu_list):
        ...
        for i,score_item in enumerate(score_list):
            ...
            mAP_Recovery.append(have*1.0/  all_rela  )
            mAP_Precision.append(have*1.0/((i+1)*1.0)+0.02)
    ...
    now_5_plist += sum(top_5_plist)
    now_5_rlist += sum(top_5_rlist)
    now_10_plist += sum(top_10_plist)
    now_10_rlist += sum(top_10_rlist)
    now_20_plist += sum(top_20_plist)
    now_20_rlist += sum(top_20_rlist)
...
print("整体")
print(now_5_plist/249)
print(now_5_rlist/249)
print(now_10_plist/249)
print(now_10_rlist/249)
print(now_20_plist/249)
print(now_20_rlist/249)
print(all_time/5)
'''
